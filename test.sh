...
for i in "${!depth[@]}";do
    for j in "${!n_ctx[@]}";do
        ...
        CUDA_VISIBLE_DEVICES=${device} python 9.py --dataset br35 \
        --data_path /home/ubuntu/wangxukang/data/Br35H --save_path ./results/${base_dir}/zero_shot \
        --checkpoint_path /home/ubuntu/wangxukang/FAPrompt-main/checkpoints-SCA-yueshu-tiaoxuexilv-fanwei5-5-2-4.pytrained_on_mvtecad/epoch_23.pth \
